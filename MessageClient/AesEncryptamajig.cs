...
namespace MessageClient
{
    ...
    public class AesEncryptamajig
    {
        ...
        /// <param name="saltBytes">salt using a secure PRNG</param>
        /// <returns>The salt and the ciphertext, Base64 encoded for convenience.</returns>
        public static string Encrypt(string plainText, string key, byte[] saltBytes)
        {
        ...
        public static string Decrypt(string cipherText, string key, byte[] saltBytes)
        {
            ...
            using (var memoryStream = new MemoryStream(allTheBytes))
